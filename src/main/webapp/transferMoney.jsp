   ...
   <div class="main-content">
        ...
        <div class="dashboard-content">
            ...
            <div class="transfer-layout">
                ...
                <div class="transfer-form">
                    <form action="${pageContext.request.contextPath}/transfer" method="post">
                        ...
                        <div class="form-section">
                            ...
                            <div class="radio-group">
                                <div class="radio-option" id="quickTransfer">
                                    ...
                                    <input type="radio" name="transferType" value="quick" checked style="display:none;">
                                </div>
                                <div class="radio-option" id="myPayee">
                                    <div class="radio-circle"><div class="radio-dot"></div></div>
                                    <span>My Payee</span>
                                    <input type="radio" name="transferType" value="payee" style="display:none;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="toAccount" placeholder="Enter account number" required>
                        </div>
                        
                        <div class="form-group">
                            <label>Re Enter To Account Number</label>
                            <input type="text" class="form-control" name="confirmToAccount" placeholder="Re-enter account number" required>
                        </div>
                ...
                <div class="transfer-banner">
                    ...
                    <p>Your transactions are protected with industry-leading encryption and security protocols. HelaBank ensures your money transfers are safe and reliable.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            const confirmToAccount = document.querySelector('input[name="confirmToAccount"]').value;
