...
<head>
    ...
    <title>HelaBank - Open New Account</title>
...
/* Dashboard Open Account Page Styling */
.dashboard-content {
    padding: 24px;
    background-color: #f5f5f5;
    border-radius: 16px;
...
.cancel-button .material-icons, .open-button .material-icons {
    font-size: 18px;
}
...
/* For a specific input with ID initialDeposit */
#initialDeposit::-webkit-outer-spin-button,
#initialDeposit::-webkit-inner-spin-button {
    ...
    <div class="main-content">
        ...
        <div class="dashboard-content">
            ...
            <div class="accounts-section">
                <h2 class="section-title">Open New Account</h2>
                ...
                <div class="account-form-container">
                    <form class="account-form" action="${pageContext.request.contextPath}/account" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="accountName" name="accountName" class="form-input" placeholder="Enter Account Name" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="select-wrapper">
                                <select id="accountType" name="accountType" class="form-select" required>
                                    ...
                                    <option value="SAVINGS - PERSONAL">Savings Account</option>
                                    <option value="Current Account">Current Account</option>
                                    <option value="DOUBLE S SAVINGS - PERSONAL">Double S Savings</option>
                                </select>
                        ...
                        <div class="form-actions">
                            <button type="button" class="cancel-button" id="cancelButton"onclick="window.location.href='${pageContext.request.contextPath}/account'" >
                                Cancel <span class="material-icons">close</span>
                            </button>
                            <button type="submit" class="open-button">
                                Open <span class="material-icons">add</span>
                            </button>
                        </div>
                    </form>
                </div>
                ...
                <div class="notice-container">
                    <div class="notice">
                        ...
                        <p> New accounts will be activated within 24 hours.</p>
                    </div>
                </div>
            </div>
        </div>
