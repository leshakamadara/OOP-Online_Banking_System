...
<div class="dashboard-content">
    ...
    <div class="accounts-section">
        ...
        <div class="account-edit-container">
            <form class="account-form" action="${pageContext.request.contextPath}/account" method="post">
                <input type="hidden" name="action" value="update">
                <input type="hidden" name="accountId" value="${account.accountId}">
                
                <div class="form-group">
                    <label for="account-number">Account</label>
                    <div class="account-number-display">${account.accountNumber} - <fmt:formatNumber value="${account.balance}" pattern="#,##0.00" /> LKR</div>
                </div>
                
                <div class="form-group">
                    <label for="account-type">Account Type</label>
                    <input type="text" id="account-type" name="accountType" value="${account.accountType}" readonly>
                </div>
                
                <div class="form-group">
                    <label for="account-name">Account Name</label>
                    <input type="text" id="account-name" name="accountName" value="${account.accountName}" placeholder="Display Acc Name and this can be edited">
                </div>
                
                <div class="form-group">
                    <label for="primary-status">Mark as Primary</label>
                    <div class="select-wrapper">
                        <select id="primary-status" name="isPrimary">
                            <option value="true" ${account.primary ? 'selected' : ''}>Primary</option>
                            <option value="false" ${!account.primary ? 'selected' : ''}>Not Primary</option>
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="select-wrapper">
                        <select id="account-status" name="active">
                ...
                <div class="form-actions">
                    <button type="button" class="cancel-button" onclick="window.location.href='${pageContext.request.contextPath}/account'">
                        Cancel <span class="material-icons">close</span>
                    </button>
                    <button type="submit" class="update-account-button">
                        Update <span class="material-icons">edit_note</span>
                    </button>
                </div>
            </form>
        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelector('.update-account-button').addEventListener('click', function() {
            const accountName = document.getElementById('account-name').value;
            const isPrimary = document.getElementById('primary-status').value === 'primary';
            const isActive = document.getElementById('account-status').value === 'active';
