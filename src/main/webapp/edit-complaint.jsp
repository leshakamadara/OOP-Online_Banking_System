...
<head>
    ...
    <title>Hela Bank - Edit Complaint</title>
    ...
    <style>
        * {
        ...
        /* Edit Complaint form specific styles */
        .container {
            max-width: 800px;
            margin: 0 auto;
            background-color: white;
...
<body>
        ...
        <div class="container">
            ...
            <form action="${pageContext.request.contextPath}/update-complaint" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="firstName" name="firstName" value="${complaint.firstName}" required>
                </div>
                
                <div class="form-group">
                    <label for="surname">Surname*</label>
                    <input type="text" id="surname" name="surname" value="${complaint.surname}" required>
                </div>
                
                <div class="form-group">
                    <label for="address">Address</label>
                    <textarea id="address" name="address" rows="3">${complaint.address}</textarea>
                </div>
                
                <div class="form-group">
                    <label for="email">Email Address*</label>
                    <input type="email" id="email" name="email" value="${complaint.email}" required>
                </div>
                
                <div class="form-group">
                    <label for="accountOrNic">Account # / NIC #</label>
                    <input type="text" id="accountOrNic" name="accountOrNic" value="${complaint.accountOrNic}">
                </div>
                
                <div class="form-group">
                    <label for="phoneNumber">Daytime Phone Number</label>
                    <input type="tel" id="phoneNumber" name="phoneNumber" value="${complaint.phoneNumber}">
                </div>
                
                <div class="form-group">
                    <label for="preferredContactTime">Preferred Contact Time</label>
                    <input type="text" id="preferredContactTime" name="preferredContactTime" 
                           value="${complaint.preferredContactTime}" placeholder="e.g., 9am-5pm">
                </div>
                
                <div class="form-group">
                    <label for="complaintDetails">Details of your complaint or suggestion*</label>
                    <textarea id="complaintDetails" name="complaintDetails" rows="5" required>${complaint.complaintDetails}</textarea>
                </div>
                ...
                <a href="${pageContext.request.contextPath}/view-complaint?id=${complaint.id}" class="btn">Cancel</a>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        function setActiveMenuItem() {
            ...
            } else if (currentPath.includes('/contact') || currentPath.includes('/update-complaint')) {
